...
class canned_table_manager {
 ...
 case 'aixada_stock_movement':
     return "['id','TRANSLATION(product)','TRANSLATION(operator_id)','TRANSLATION(movement_type)','TRANSLATION(amount_difference)','Descripci\u00f3','TRANSLATION(resulting_amount)','TRANSLATION(ts)']";

 case 'aixada_stock_movement_type':
     return "['id','Nom','Descripci\u00f3']";
 ...
 case 'aixada_stock_movement_type':
     return "[{name:'id',index:'id',label:'id',width:'150',xmlmap:'id',editable:false,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'name',index:'name',label:'Nom',width:'30',xmlmap:'name',editable:true,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'description',index:'description',label:'Descripci\u00f3',width:'255',xmlmap:'description',editable:true,hidden:false,editrules:{edithidden:true,searchhidden:true}}]";
